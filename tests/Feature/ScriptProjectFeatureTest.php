...
class ScriptProjectFeatureTest extends TestCase
{
    ...
    public function test_workspace_view_groups_pages_diagrams_and_scripts_by_category(): void
    {
        ...
        $this->actingAs($owner)
            ...
            ->assertSee('data-bs-target="#workspace-categories-body"', false)
            ->assertSee('id="workspace-categories-body" class="collapse"', false)
            ->assertSee('accordion-button collapsed bg-white', false)
            ->assertSeeText('Story')
