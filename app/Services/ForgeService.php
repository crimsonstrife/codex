...
class ForgeService
{
    ...
    protected bool $disableTlsVerification;
    ...
    {
        $this->baseUrl = CodexRuntimeConfig::forgeUrl();
        $this->clientId = CodexRuntimeConfig::forgeApiClientId();
        $this->clientSecret = CodexRuntimeConfig::forgeApiClientSecret();
        $this->disableTlsVerification = CodexRuntimeConfig::forgeDisableTlsVerification();
    }
